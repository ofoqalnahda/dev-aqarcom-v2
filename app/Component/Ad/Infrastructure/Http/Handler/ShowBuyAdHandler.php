    ...
    responses: [
        new OA\Response(response: 200, description: 'Success', content: new OA\JsonContent(
            properties: [
                ...
                new OA\Property(property: 'data', ref: '#/components/schemas/AdBuyViewModel'),
            ],
            type: 'object'
        )),
...
class ShowBuyAdHandler extends Handler
{
    ...
    public function __invoke($slug): JsonResponse
    {
        try {
            ...
            $ad = $this->adService->findBySlug($slug);
            $ad = $this->adMapper->toBuyViewModel($ad);

            return  responseApi($ad);
        } catch (\Exception $e) {
